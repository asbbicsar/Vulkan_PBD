...
This project is a cloth simulation implemented by PBD using the Vulkan API. To optimize storage space and portability, the Vulkan SDK is not included, and the local SDK is referenced via environment variables.
